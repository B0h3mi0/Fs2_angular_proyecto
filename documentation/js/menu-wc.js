...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">angular-proyecto documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/Aside.html" data-type="entity-link" >Aside</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/LoginForm.html" data-type="entity-link" >LoginForm</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/Productos.html" data-type="entity-link" >Productos</a>
                            </li>
                            <li class="link">
                                <a href="components/RecuperaPass.html" data-type="entity-link" >RecuperaPass</a>
                            </li>
                            <li class="link">
